...
export const FooterSection: FC = () => {
  return (
    <motion.footer 
      ...
      className="relative bg-black text-white border-t-4 border-white shadow-[0_-10px_0_0_#000000] overflow-hidden uppercase font-mono"
    >
      {/* Top Border / Marquee style or small text */}
      <motion.div variants={itemVariants} className="border-b-4 border-white px-6 py-4 flex justify-between items-center text-xs md:text-sm tracking-widest">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12">
        {/* Left Column (Links) */}
        <div className="md:col-span-8 border-r-4 border-white">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 h-full">
            <motion.div variants={itemVariants} className="border-b-4 sm:border-r-4 border-white p-8 md:p-12 flex flex-col justify-between min-h-[250px]">
            ...
            <motion.div variants={itemVariants} className="border-b-4 border-white sm:border-r-0 lg:border-r-0 p-8 md:p-12 flex flex-col justify-between min-h-[250px] col-span-1 sm:col-span-2 lg:col-span-1">
        ...
        <motion.div variants={itemVariants} className="md:col-span-4 p-8 md:p-12 flex flex-col justify-between border-b-4 border-white md:border-b-0">
          ...
          <div>
            ...
            <a href="mailto:hola@nomades.uy" className="inline-block px-8 py-4 text-sm font-black bg-[#FF4D00] text-white border-4 border-white shadow-[6px_6px_0_0_#000000] hover:bg-white hover:text-black hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all whitespace-nowrap">
              ENVIAR EMAIL
            </a>
          </div>
        </motion.div>
      ...
      {/* Massive Bottom Text */}
      <motion.div variants={itemVariants} className="border-t-4 border-white overflow-hidden flex items-end justify-center pt-8 pb-4">
        <h2 
          className="text-[15vw] leading-[0.75] font-black tracking-tighter text-white drop-shadow-[4px_4px_0_#FF4D00]"
